...
distdir: FORCE
	...
	$(COPY_FILE) --parents gauge.hh gaugeCluster.hh $(DISTDIR)/
	$(COPY_FILE) --parents gauge.cc gaugeCluster.cc main.cc $(DISTDIR)/
...
compiler_moc_header_make_all: moc_gauge.cpp moc_gaugeCluster.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gauge.cpp moc_gaugeCluster.cpp
...
main.o: main.cc gaugeCluster.hh
